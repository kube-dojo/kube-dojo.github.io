...
Для серйозної роботи збережіть копію ефективної конфігурації поруч зі звітом виводу. Ця практика значно полегшує пізніші порівняння, бо артефакт несе доказ того, як його отримали.
...
| Потрібна передача           | залежність від племінного знання | задокументувати команди й макет |
+-----------------------------+-----------------------------+------------------------------+
```
