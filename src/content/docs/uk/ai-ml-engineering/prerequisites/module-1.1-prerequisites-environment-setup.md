...
---
> **Трек «Інженерія ШІ/МН»** | Складність: `[QUICK]` | Час: 2-3 години
>
...
- **Реалізувати** план налаштування з урахуванням GPU, який фіксує, чи NVIDIA CUDA або AMD ROCm належать хосту, середовищу в стилі Conda, чи стеку wheel-пакетів Python.
...
- [ ] Оберіть, чи цей проєкт використовує `pyenv` плюс `venv`, Conda чи micromamba, і напишіть одне речення, яке пояснює найскладнішу залежність, що визначила вибір.
