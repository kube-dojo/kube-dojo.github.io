...
- [Kubernetes 1.35 — About cgroup v2 (cgroup v1 deprecated; kubelet fails on v1 by default)](https://v1-35.docs.kubernetes.io/docs/concepts/architecture/cgroups/)
- [Kubernetes 1.35 kubelet — `--fail-cgroupv1` default true](https://v1-35.docs.kubernetes.io/docs/reference/command-line-tools-reference/kubelet/)
- [KubeletConfiguration `failCgroupV1` (default true)](https://kubernetes.io/docs/reference/config-api/kubelet-config.v1beta1/)
