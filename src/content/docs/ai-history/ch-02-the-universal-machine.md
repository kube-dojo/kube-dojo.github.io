...
- [Turing, “On Computable Numbers”](https://www.cs.virginia.edu/~robins/Turing_Paper_1936.pdf) — §3 Example I, printed pp. 233–234/PDF pp. 4–5; §6, printed pp. 241–242/PDF pp. 12–13; §8, printed pp. 247–248/PDF pp. 18–19; §11 PDF p. 29; appendix pp. 263–265/PDF pp. 34–36. The paper supplies the machine-table example, the mathematical specification of U, and the no-general-process results; printed p. 265 carries the Graduate College return address; the appendix presents the equivalence in outline and leaves auxiliary constructions unproved.
