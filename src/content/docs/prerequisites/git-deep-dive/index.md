...
| 4 | [Module 4: The Safety Net — Undo and Recovery](module-4-undo-recovery/) | 100–130 min | reset, reflog, revert — never lose code again |
...
| 9 | [Module 9: Automation and Customization — Hooks and Rerere](module-9-hooks-rerere/) | 100–140 min | Hooks, rerere, aliases, team config |
...
These are planning estimates copied from the ten module headers, not measured learner completion times. Their arithmetic gives an aggregate range of **920–1240 minutes (about 15 hours 20 minutes–20 hours 40 minutes)**; individual setup, reading, and practice time will vary.
