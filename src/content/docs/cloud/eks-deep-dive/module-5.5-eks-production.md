...
Treating compute instances as ephemeral entities shifts operational focus from individual node longevity to holistic capacity management across diverse instance families. Finance reviews then compare interruption rates per instance family against On-Demand spend, and application owners own shutdown behavior the same way they own HTTP health checks.
